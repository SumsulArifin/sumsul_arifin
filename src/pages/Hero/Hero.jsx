...
export default function Hero() {
  ...
  const [code] = useState(`
const profile = {
    name: 'MD.Sumsul Arfin',
    title: 'Full-Stack Developer | Cloud Enthusiast | Problem Solver',
    skills: [

        'Java','React', 'Node js', 'Redux', 'Express',
  ...
  useEffect(() => {
   ...
   const pdfUrl = "/Md_Sumsul_Arifin (1).pdf";
        ...
        >
          ...
          >
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              {/* Welcome badge */}
              <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-2 rounded-full bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 mb-10 sm:mb-8 animate__animated animate__fadeInDown animate__delay-1s">
